...
"lang": "en-US",
"title": "ctrl-ing",
"subtitle": "Interactively control your Web-App, JSON or JavaScript Object Values",
...
"tags": ["controlling","webapp","JSON","javascript","object","custom element"]
---
...
* The `chk` section in the JSON content accesses the `toggle` member of the reference object `obj` via its `path` property using standard [JSONPath](https://ietf-wg-jsonpath.github.io/draft-ietf-jsonpath-base/draft-ietf-jsonpath-base.html#name-normalized-paths) syntax.
